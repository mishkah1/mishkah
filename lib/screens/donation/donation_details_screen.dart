...
/// الخاص بالجمعية المحتضنة للدار المختارة.
class DonationScreen extends StatelessWidget {
  ...
  // TODO: بدّل الرابط بمسار الصورة الفعلي اللي بتستخدمها بكل شاشات التبرع
  ...
  Future<void> _openDonationLink(BuildContext context) async {
    final link = dar.donationLink;
    if (link == null || link.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('رابط التبرع غير متوفر حالياً')),
      );
      return;
    }
    ...
    if (await canLaunchUrl(uri)) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('تعذر فتح رابط التبرع')),
      );
    }
  }
        ...
        child: Row(
          children: [
            Container(
              ...
              child: const Icon(Icons.favorite, color: _gold, size: 22),
            ),
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    ...
                    style: TextStyle(color: Color(0xFFCFC9B8), fontSize: 11.5),
                  ),
                ],
              ),
            ),
            const Icon(Icons.arrow_back_ios, color: _gold, size: 14),
          ],
        ),
      ),
    );
