...
class DarDetailsScreen extends StatelessWidget {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...halaqas.map((h) => _buildHalaqaTile(context, h)),
                ],
              ),
            ),
          ),
      ...
      child: Row(
        children: [
          Container(
            ...
            child: const Icon(Icons.mosque, color: _darkGreen),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    const Icon(Icons.location_on, size: 13, color: _muted),
  ...
  Widget _buildHalaqaTile(BuildContext context, HalaqaModel halaqa) {
    final isOpen = halaqa.registrationStatus == RegistrationStatus.open;
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (_) => HalaqaDetailsScreen(halaqa: halaqa, dar: dar),
            ),
          );
        },
        child: Container(
  ...
  Widget _buildStatusBadge(bool isOpen) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: isOpen ? const Color(0xFFEAF3DE) : const Color(0xFFFAEEDA),
      ...
      child: Text(
        ...
        style: TextStyle(
          fontSize: 10,
          color: isOpen ? const Color(0xFF2D4A16) : const Color(0xFF5C3D02),
        ),
      ),
    );
  }
